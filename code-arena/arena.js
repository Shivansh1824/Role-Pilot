...
const initGeminiApiKey = () => {
    ...
    if (!key) {
        localStorage.setItem('rolepilot_gemini_api_key', 'AQ.Ab8RN6LTt3_q2dmyZtlC-7e0olml_speVkQX6nEYcrd0yXlWAQ');
    }
};
initGeminiApiKey();
        ...
        startBtns.forEach(btn => {
            btn.addEventListener('click', async () => {
                ...
                if (ascentQuestions.length === 3) {
                    ...
                    try {
                        const apiKey = localStorage.getItem('rolepilot_gemini_api_key') || 'AQ.Ab8RN6LTt3_q2dmyZtlC-7e0olml_speVkQX6nEYcrd0yXlWAQ';
